...
chain = sample(m1, NUTS(200, 0.65), MCMCThreads(), 2_000, num_chains)
...
chain2 = sample(m2, NUTS(), MCMCThreads(), 500, num_chains)
...
manifest_format = "2.0"
project_hash = "f86827d1eae00539ce4144811eb7c6e5db848640"

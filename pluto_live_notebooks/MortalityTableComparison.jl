...
available_names = sort!(collect(keys(MortalityTables.table_source_map)))
...
let
	...
	plot(p1,p2,size=(980,400),titlefontsize=9,bottom_margin=5Plots.mm)
...
begin
	...
	plot(titleplot,c1,c2,size=(980,400),layout= l,bottom_margin=5Plots.mm,left_margin=5Plots.mm)
...
manifest_format = "2.0"
project_hash = "915017ac7fd7764cc736c0baab2c8ed194174ffc"
...
git-tree-sha1 = "4f7b797ce63ec1e70467db23f0a7566d3fd81049"

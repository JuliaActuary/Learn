...
# ╔═╡ 769f0d27-d3fc-4cba-bdca-63c08ef49e41
using FinanceCore
...
# ╔═╡ b48835fc-607c-4b88-a203-12196194c505
using DataFrames, CSV

# ╔═╡ 3dfe93f4-fa67-43ab-b04f-e34d84cd6c79
...
Download this notebook: [https://github.com/JuliaActuary/Learn/tree/master/intro-video](https://github.com/JuliaActuary/Learn/tree/master/intro-video)

## Recorded for: SOA Impact 2022 
### Presented by Alec Loudenback
...
reshape(0.0:14.0,3,5) # can infer type from 0 or 0.
...
Simiilar in concept to Jupyter (**Julia**, **Pyt**hon, **R**), but has the following advantages:
...
md"""
### Data Science
Julia is a top-notch data science language.
...
# ╔═╡ 76247fcc-40f9-46e7-9bac-2d4ed97e6e8f
md""" #### Penguins"""

# ╔═╡ cded5a04-3f97-4670-912b-3c9872cdebb2
md"""
$(Resource("https://raw.githubusercontent.com/allisonhorst/palmerpenguins/master/man/figures/lter_penguins.png"))

*Credit: [palmerpenguins](https://github.com/allisonhorst/palmerpenguins)*
"""

# ╔═╡ 3691567a-9d96-4fcf-a02a-30b716944a90
penguins = let 
	file = download("https://gist.githubusercontent.com/slopp/ce3b90b9168f2f921784de84fa445651/raw/4ecf3041f0ed4913e7c230758733948bc561f434/penguins.csv")
	
	df = CSV.read(file,DataFrame,missingstring="NA")

	df = select!(df,Not(:rowid)) # drop the rowid column
	df = dropmissing!(df)        # drop rows with missing data
	
end

# ╔═╡ f739f95f-d586-41d1-8134-40a58735d430
@df penguins scatter(
	:bill_length_mm,
	:body_mass_g,
	group = :species,
...
begin
	...
	data_to_plot = select(penguins,Not(:year))
	sns.pairplot(pytable(data_to_plot),hue="species")
end
...
# ╔═╡ 13804983-0fe5-485d-9b80-e12314d934d2
sum(1:1000)

# ╔═╡ d8062d0c-a0c5-4ead-90fb-796ddc6602b3
sum(1.:1000.)

# ╔═╡ 1e5e1d3d-5f9f-48f1-8001-66e94ec55fc6
md"""
### TTFX 
...
# ╔═╡ a29d7e3d-080b-48f3-b383-599452712fe9
retained(pol_1)

# ╔═╡ b26321a8-7d4c-4901-829d-6e22e9d1d2aa
retained(pol_2)
...
[compat]
ActuaryUtilities = "~3.10.0"
BenchmarkTools = "~1.3.1"
CSV = "~0.10.4"
CondaPkg = "~0.2.13"
DataFrames = "~1.3.6"
FinanceCore = "~1.0.1"
LifeContingencies = "~2.3.0"
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "448df6605fc56a1b104e9ce5361bc29b360eef72"
...
deps = ["Dates", "Distributions", "FinanceCore", "ForwardDiff", "MuladdMacro", "QuadGK", "Reexport", "SnoopPrecompile", "StatsBase", "Yields"]
git-tree-sha1 = "0b90963a1e05d14f5256a3fdf4dcd8caf36f30f9"
uuid = "bdd23359-8b1c-4f88-b89b-d11982a786f4"
version = "3.10.0"
...
git-tree-sha1 = "6fd7e2558ef522858dbd976087efbe3d48fc2190"
...
[[deps.FinanceCore]]
deps = ["Roots"]
git-tree-sha1 = "2a84433fd7850a93c5fa9aa262f6d718d64a1352"
...
git-tree-sha1 = "72aa5d3398967c4d717d00c22d468478ec2a707d"
...
git-tree-sha1 = "0fef61fed2820cb239edf97e60286d67cda6c884"
...
[[deps.Yields]]
deps = ["BSplineKit", "FinanceCore", "ForwardDiff", "LinearAlgebra", "LsqFit", "Optim", "Reexport", "Roots", "UnicodePlots"]
git-tree-sha1 = "a10ebf58db3b5b364d21ea36c9df2e58686dc4e9"
